...
export class AddGameComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.lockOpen = false;
    this.points = [-96, -72, -66, -60, -54, -48, -46, -44, -40, -36, -33, -30, -27, 0, 18, 20, 22, 23, 24, 27, 30, 33, 35, 36, 40, 44, 45, 46, 48, 50, 54, 55, 59, 60, 63, 66, 70, 72, 77, 80, 81, 96, 120, 144, 168, 192, 216, 240, 264];
    this.menuhelper = -1;
